 ...
 */
namespace Sow\Slider\Model\ResourceModel;
...
class Block extends AbstractDb
{
    ...
    {
        $this->_init('sow_slider_banner', 'block_id');
    }
     ...
     * Load an object
     *
     * @param \Sow\Slider\Model\Block|AbstractModel $object
     * @param mixed $value
    ...
    protected function _getLoadSelect($field, $value, $object)
    {
        ...
        if ($object->getStoreId()) {
            ...
            $select->join(
                ['cbs' => $this->getTable('sow_slider_banner_store')],
    ...
    public function lookupStoreIds($id)
    {
        ...
        $select = $connection->select()
            ->from(['cbs' => $this->getTable('sow_slider_banner_store')], 'store_id')
            ->join(
