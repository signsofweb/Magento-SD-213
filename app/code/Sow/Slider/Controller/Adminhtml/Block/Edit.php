...
class Edit extends \Sow\Slider\Controller\Adminhtml\Block
{
    /**
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Sow\Slider\Model\Block');
        ...
        $this->_coreRegistry->register('sow_slider_banner', $model);
