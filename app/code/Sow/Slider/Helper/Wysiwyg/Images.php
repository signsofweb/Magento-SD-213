 ...
 */
namespace Sow\Slider\Helper\Wysiwyg;
...
class Images extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function __construct(
        ...
        $this->_directory->create(\Sow\Slider\Model\Wysiwyg\Config::IMAGE_DIRECTORY);
    }
    ...
    {
        return $this->_directory->getAbsolutePath(\Sow\Slider\Model\Wysiwyg\Config::IMAGE_DIRECTORY);
    }
    ...
    public function getCurrentPath()
    {
        if (!$this->_currentPath) {
            $currentPath = $this->_directory->getAbsolutePath() . \Sow\Slider\Model\Wysiwyg\Config::IMAGE_DIRECTORY;
