...
namespace Sow\Slideshow\Ui\Component\Listing\Column;
...
use Sow\Slideshow\Ui\Component\Listing\Column\AbstractColumn;
        ...
        if (isset($item[$this->getData('name')])) {
            if ($item[$this->getData('name')]) {
                $srcImage = $this->_storeManager->getStore()
                        ->getBaseUrl(UrlInterface::URL_TYPE_MEDIA).'sow/slideshow/sliders/' . $item[$this->getData('name')];
