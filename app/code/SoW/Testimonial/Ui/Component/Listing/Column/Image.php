...
namespace SoW\Testimonial\Ui\Component\Listing\Column;
...
use SoW\Testimonial\Ui\Component\Listing\Column\AbstractColumn;
        ...
        if (isset($item[$this->getData('name')])) {
            if ($item[$this->getData('name')]) {
                $srcImage = $this->_storeManager->getStore()
                        ->getBaseUrl(UrlInterface::URL_TYPE_MEDIA).'sow/testimonial/testimonials/' . $item[$this->getData('name')];
