...
class Latest extends \Magento\Framework\View\Element\Template
{
     ...
     * @param \Field\Blog\Model\Post                             $postFactory 
     * @param \Field\Blog\Helper\Data                            $blogHelper  
     * @param array                                            $data        
     */
    ...
    {	
    	...
    	$this->pageConfig->addBodyClass('field-bloglatest');
    	if($page_title){
    ...
    {
        $block = $this->getLayout()->getBlock('fieldblog_toolbar');
        if ($block) {
            return $block;
        }
    }
